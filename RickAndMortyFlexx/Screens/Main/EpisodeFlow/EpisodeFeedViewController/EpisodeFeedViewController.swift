//
//  EpisodeFeedViewController.swift
//  RickAndMortyFlexx
//
...
class EpisodeFeedViewController: BaseViewController<EpisodeFeedViewModel> {
	...
	override func setupStyle() {
		...
		searchController.searchBar.placeholder = "Search character by name or code"
		searchController.hidesNavigationBarDuringPresentation = true
		definesPresentationContext = true
		searchController.isActive = false
		
		self.navigationItem.searchController = searchController
		self.navigationItem.setCustomTitle(text: "Episodes")
