...
final class LocationDetailViewController: BaseViewController<LocationDetailViewModel> {
	...
	enum Section: Int {
		case locationHeader
		case charactersInLocation
		
		var sectionName: String {
			switch self {
				case .locationHeader: return "Location"
				case .charactersInLocation: return "Characters"
			}
		}
	}
	...
	override func viewDidLoad() {
		createDataSource()
		self.navigationItem.setCustomTitle(text: "Location details")
		super.viewDidLoad()
	}
